...
// let selectOne = document.querySelector("h1") //return 
// let selectOne = document.querySelector(".para1") //for class we use .
let selectOne = document.querySelector("#uniq-para") //for id we use#
